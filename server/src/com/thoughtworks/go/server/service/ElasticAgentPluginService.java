...
public class ElasticAgentPluginService {
    ...
    public void heartbeat() {
        ...
        for (PluginDescriptor descriptor : elasticAgentPluginRegistry.getPlugins()) {
            ...
            ArrayList<AgentMetadata> metadatas = ListUtil.map(elasticAgentMetadatas, new ListUtil.Transformer<AgentMetadata, ElasticAgentMetadata>() {
                @Override
        ...
        if (!elasticAgents.isEmpty()) {
            for (String pluginId : elasticAgents.keySet()) {
                ...
                List<String> uuids = ListUtil.map(elasticAgents.get(pluginId), new ListUtil.Transformer<String, ElasticAgentMetadata>() {
                    @Override
